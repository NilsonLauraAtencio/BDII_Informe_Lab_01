...
no tengan un administrador (manager).
	...
	\\ \\declare @gerente as int; set @gerente = 103; select employee_id,last_name,salary,department_id from employees where manager_id = @gerente order by last_name; set @gerente = 201; select employee_id,last_name,salary,department_id from employees where manager_id = @gerente order by salary; set @gerente = 124; select employee_id,last_name,salary,department_id from employees where manager_id = @gerente order by employee_id;
